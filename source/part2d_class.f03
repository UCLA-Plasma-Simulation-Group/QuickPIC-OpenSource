...
! update: 04/18/2016
      ...
      public :: part2d
      public :: p_push_std, p_push_robust
...
! ncll/nclr/mcll/mclr = number offsets send/received from processors
      ...
      ! push type
      integer, parameter :: p_push_std = 0, p_push_robust = 1
      
      contains
!
      subroutine init_part2d(this,pp,perr,psp,pf,fd,qbm,dt,ci,xdim,s,push_type)
         ...
         integer, intent(in) :: xdim, push_type
...
! local data
         ...
         case (p_push_robust)
            ...
            call PPGRDCJPPOST2L_RB(this%ppart,pef,pbf,ppsit(1,:,:),pcu,pdcu,&
            &pamu,this%kpic,noff,nyp,this%qbm, this%dt,this%ci,this%xdim,&
            &this%nppmx0,nx,mx,my,nxv,nypmx,mx1,mxyp1,dex)
...
! local data
         ...
         case (p_push_robust)
            ...
            call PPGRBPPUSHF23L_RB(this%ppart,pef,pbf,ppsit(1,:,:),this%kpic,&
            &this%ncl,this%ihole,noff,nyp,this%qbm,this%dt,this%dt,this%ci,ek,&
            &this%xdim,this%nppmx0,nx,ny,mx,my,nxv,nypmx,mx1,mxyp1,this%ntmaxp,&
            &this%irc,dex)
...
! check for errors
         if (this%irc /= 0) then
            write (erstr,*) 'PPGRBPPUSHF23L error, irc=', this%irc
            call this%err%equit(class//sname//erstr); return
         endif
